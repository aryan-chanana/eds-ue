...
export default async function decorate(block) {
  ...
  const mobileTopDIv = document.createElement('div');
  mobileTopDIv.className = 'mobile-top-div';
  ...
  mobileTopDIv.append(menuToggle);

  const svgMobileLocation = document.createElement('div');
  svgMobileLocation.className = 'mobile-location-div';
  svgMobileLocation.innerHTML = ` <?xml version="1.0" encoding="utf-8"?>
...
<path fill="#231F20" d="M32,0C18.746,0,8,10.746,8,24c0,5.219,1.711,10.008,4.555,13.93c0.051,0.094,0.059,0.199,0.117,0.289l16,24
  ...
  mobileTopDIv.append(svgMobileLocation);
  headerInner.append(mobileTopDIv);
